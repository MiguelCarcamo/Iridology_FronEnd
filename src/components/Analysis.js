...
const url1 = 'https://208.109.191.54/api/Analysis/';
const url2 = 'https://208.109.191.54/api/AnalysisSistems/';
const url3 = 'https://208.109.191.54/api/AnalysisBodyOrgans/';
...
const EnviarDatos2 = async () => {
  var url = 'https://208.109.191.54/api/Analysis/update2'
...
const SaveData = async() => {
  ...
  if(false){
    ...
    var url = 'https://208.109.191.54/api/AnalysisBodyOrgans/update'
    ...
    var url = 'https://208.109.191.54/api/AnalysisSistems/update'
...
const UpdateDataRange = async () =>  {
  try {
      const data = await fetch('https://208.109.191.54/api/SetupRange/');
      const data1 = await data.json();
      setRowData5(data1);
  } catch (error) {
     console.log(error); 
