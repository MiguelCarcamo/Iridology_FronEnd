...
function SetupFindings() {
    ...
    const url = 'https://iridologo.org/api/SetupFindings/';
    const url3 = 'https://iridologo.org/api/SetupFindings/add';
    const url4 = 'https://iridologo.org/api/SetupFindings/update';
    ...
    const EnviarDatos2 = async () => {
        var url = 'https://iridologo.org/api/SetupFindings/delete'
