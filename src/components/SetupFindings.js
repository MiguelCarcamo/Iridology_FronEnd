...
function SetupFindings() {
    ...
    const url = 'http://127.0.0.1:5000/api/v1/findings';
    ...
    const handleOpenNew = () => { 
        setAction(0);
        setFormValue({IDSetupBodyOrgans : 0, Foods : "", NotFoods : "", Findings : "", RangeMax : 0, RangeMin : 0 });
        setOpen(true);
    }
    const handleOpenUpdate = () => { 
        if (!rowDataEdi.id){
            ...
            setFormValue({IDSetupBodyOrgans : rowDataEdi.IDSetupBodyOrgans , Foods : rowDataEdi.Foods , NotFoods : rowDataEdi.NotFoods, Findings : rowDataEdi.Findings, RangeMax : rowDataEdi.RangeMax, RangeMin : rowDataEdi.RangeMin });
            setOpen(true);
        }
    }    
                ...
                <Grid component={Paper} elevation={6} square>
                    ...
                    <Typography component="h1" variant="h5">Findings</Typography>
                        <Box component="form" noValidate sx={{ mt: 1 }}>
                            ...
                            <TextField multiline onChange={handleChange} value={formValue.Findings} margin="normal" fullWidth id="Findings" label="Findings" name="Findings"/>
                            <TextField multiline onChange={handleChange} value={formValue.Foods} margin="normal" fullWidth id="Foods" label="Foods" name="Foods"/>
                            <TextField multiline onChange={handleChange} value={formValue.NotFoods} margin="normal" fullWidth id="NotFoods" label="NotFoods" name="NotFoods"/>
